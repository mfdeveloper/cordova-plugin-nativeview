#
#  Be sure to run `pod spec lint cordova-plugin-nativeview.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Michel Felipe" => "mfelipeof@gmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "mfelipeof@gmail.com" }
