...
/**
 * The code below is copied from http://gist.github.com. All rights reserved
 * @see https://gist.github.com/marcocarnazzo/6f01a57d390e8fe3071f
 */
...
var platformConfig = (function(){
    ...
    return {
        ...
        getConfigXml: function () {
            if(!configXmlData) {
                configXmlData = this.parseElementtreeSync(path.join(this.rootDir || rootdir, 'config.xml'));
            }
        ...
        updatePlatformConfig: function (platform) {
            var configData = this.parseConfigXml(platform),
                platformPath = path.join(this.rootDir || rootdir, 'platforms', platform);
...
module.exports = function (ctx) {
    ...
    platformConfig.rootDir = ctx.opts.projectRoot;
    if (rootdir || platformConfig.rootDir) {
